...
namespace estate_executor
{
    ...
    {
       const int zhangNumber = zhang::bank_number_part(secret_modifier);
       const int khanNumber = khan::bank_number_part(secret_modifier);
       const int garciaNumber = garcia::bank_number_part(secret_modifier);
       return zhangNumber + garciaNumber + khanNumber;
    }
}